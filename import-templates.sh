...
# change the NS parameter to be your project name on OSO

NS=openshift

# EAP 7.1
oc replace -n ${NS} --force -f https://raw.githubusercontent.com/jboss-openshift/application-templates/master/eap/eap71-image-stream.json
...
do
  oc replace -n ${NS} --force -f https://raw.githubusercontent.com/jboss-openshift/application-templates/master/eap/$resource
done
...
for resource in amq63-basic.json \
 ...
 amq63-ssl.json 
do
  oc replace -n ${NS} --force -f https://raw.githubusercontent.com/jboss-openshift/application-templates/master/amq/$resource
done
